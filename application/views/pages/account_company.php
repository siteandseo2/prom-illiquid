				...
				<form id="cabinet-my-account" class="form-submit clearfix" action="" method="POST" enctype="multipart/form-data">
					...
					<div class="col-sm-6">
						...
						<p>
							...
							<input type="text" value="isitinme88@gmail.com" id="account_email" name="account_email" class="cabinet-form-input">
						</p>
						<p>
							<label for="account_phone">Телефон</label>
							<input type="text" value="+38 095 896 24 70" id="account_phone" name="account_phone" class="cabinet-form-input">
						</p>
						<!-- 
						<p>
