                ...
                <table class='col-lg-12 table-bordered table-responsive table'>
                    ...
                    foreach ($pages as $item) {
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type='text' name="name[<?= $item['id'] ?>]" value="<?= $item['name'] ?>" disabled="disable"/>                               
                            </td>                            
                            <td><input class="form-control" type='text' name="link[<?= $item['id'] ?>]" value="<?= $item['link'] ?>"disabled="disable" /></td>               
